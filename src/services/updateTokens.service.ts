...
import {
	getUserDataExternalByRefreshTokenRepository
} from "../repositories/getUserDataExternalByRefreshToken.repository";
...
export const updateTokensService = async (
	...
	const user_account = await getUserAccountByUserIdRepository(user_data_external.user_id);
